...
idx=['Modelname','Feature','n_in_time','use_time','mse','nse','r2','Test_mse','Test_nse','Test_r2']
col = ['ARIMA']
_df = pd.DataFrame(["ARIMA","None","all_retrain",time_,'None', 'None','None',Tmse, Tnse,Tr2],index=idx,columns=col)
