...
n_pca = 7
#-----------------------Baseline / Hybrid -----------------------------------#
save_path =host_path+'Wavelet_ex05_2'
import os
...
X_train, _ = split_xy(w_train,n_past,n_future)
X_test, _ = split_xy(w_test,n_past,n_future)
##----------- Run Experiment -----------------##

for batch_size in [32]:
    run_code(build_cnn1d(),batch_size,'wCNN1D-[mm]-[noYscale]_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
    run_code(build_lstm(),batch_size,'wCuDNNLSTM=[mm]-[noYscale]_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
    # run_code(build_ende_lstm(),batch_size,'wautoLSTM_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))

    # run_code(build_wann(),batch_size,'wANN_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
    # # run_code(build_cnn_cnn(),batch_size,'wCNNcnn_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
    # run_code(build_cnn_lstm(),batch_size,'wCNN-CuDNNLSTM_v4_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
    # run_code(build_cnn_autolstm(),batch_size,'wCNN-AutoLSTM_MAR{}_b{}_Tin{}'.format(cutoff,batch_size,n_past))
