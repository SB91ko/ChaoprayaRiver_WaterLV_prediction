...
#-----------------------Baseline / Hybrid -----------------------------------#
save_path =host_path+'Wavelet_pca'
...
for batch_size in [16,32]:
    run_code(build_cnn1d(),batch_size,'wCNN1D_MAR{}_b{}_Tin{}_{}'.format(cutoff,batch_size,n_past,syn))
    run_code(build_lstm(),batch_size,'wCuDNNLSTM_MAR{}_b{}_Tin{}_{}'.format(cutoff,batch_size,n_past,syn))