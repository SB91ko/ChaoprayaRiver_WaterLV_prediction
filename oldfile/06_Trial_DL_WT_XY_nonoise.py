...
#-----------------------Baseline / Hybrid -----------------------------------#
save_path =host_path+'06_wtXY_v2_no_noisetrial_baseonOriginalwtXY'
...
# TODO #####$$$$ อันนนี้ ตั้งใจแยก X Y แล้วสุ่มRANDOMได ้!!!!! 
...
for batch_size in [16,32]:
    model_A = [build_cnn1d(),build_cnn1d(),build_cnn1d(),build_cnn1d()]
    wav_dl_wav_run(model_A,batch_size,'wCNN_MAR{}_b{}_Tin{}_{}'.format(cutoff,batch_size,n_past,syn))
    ...
    wav_dl_wav_run(model_C,batch_size,'w_best_LSTM_dCNN_ANN_MAR{}_b{}_Tin{}_{}'.format(cutoff,batch_size,n_past,syn))